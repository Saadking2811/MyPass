    ...
    private fun fakeRemoteFlights(): List<FlightItinerary> {
        return listOf(
            FlightItinerary(
                ...
                departureTime = "2026-04-12 10:30",
                arrivalTime = "2026-04-12 13:45",
                duration = "3h 15m",
                gate = "A12",
                terminal = "T1",
                seatClass = "Economy",
            ...
            FlightItinerary(
                id = "f2",
                bookingReference = "ZX98MN",
                lastName = "SMITH",
                passengerName = "Anna Smith",
                flightNumber = "AH 244",
                airlineName = "Air Algérie",
                ...
                departureTime = "2026-04-13 21:10",
                arrivalTime = "2026-04-14 05:05",
                duration = "6h 55m",
                gate = "C03",
                terminal = "T2",
                seatClass = "Business",
            ...
            FlightItinerary(
                ...
                departureTime = "2026-04-14 07:00",
                arrivalTime = "2026-04-14 08:15",
                duration = "1h 15m",
                gate = "B08",
                terminal = "T1",
                seatClass = "Economy",
            ...
            FlightItinerary(
                id = "f4",
                bookingReference = "MN77RS",
                lastName = "HADJ",
                passengerName = "Fatima Hadj",
                flightNumber = "AH 510",
                airlineName = "Air Algérie",
                aircraftType = "Boeing 737-800",
                origin = "ALG",
                ...
                departureTime = "2026-04-15 14:30",
                arrivalTime = "2026-04-15 19:15",
                duration = "3h 45m",
                gate = "D05",
                terminal = "T1",
                seatClass = "Economy",
